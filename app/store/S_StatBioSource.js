/**
 * S_IdentifiersMetabolite
 * load all GeneIdentifiers of BioSource
 * model : MetExplore.model.Identifiers
 */
Ext.define('MetExplore.store.S_StatBioSource',{
	extend : 'Ext.data.Store',
	model: 'MetExplore.model.StatBioSource',
	autoLoad: false,

	proxy: {
		type: 'ajax',
		timeout: 1200000,
		url: 'resources/src/php/dataNetwork/statBioSource.php',
		extraParams: {
			idBioSource:""
		},
		reader : {
