module.exports = function(config) {
    config.set({
        ...
        basePath: '/metexplore/metexplore-test',
        ...
        // 6 unit test files        
        files: [
            //"http://localhost/metexplore/MetExplore/ext/ext-all.js", // 1
            //"http://localhost/extjs421/ext-all.js", // 1
            "../metexplore/ext/ext-all.js",
            "../karma_app_test.js", // 2
        ...
        proxies: {
            "data/": "http://localhost:9876/metexplore/metexplore-test/data"
        },
