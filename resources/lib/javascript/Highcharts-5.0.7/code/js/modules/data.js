    ...
    (function(g) {
        ...
        g.extend(u.prototype, {
            ...
            parseCSV: function() {
                var b = this,
                    ...
                    k = a.startColumn || 0,
                    t = a.endColumn || Number.MAX_VALUE,
                    h, g, y = 0;
            ...
            parseTable: function() {
                var b = this.options,
                    ...
                    c = b.startColumn || 0,
                    k = b.endColumn || Number.MAX_VALUE;
            ...
            parseColumn: function(b, a) {
                var d = this.rawColumns,
                    f = this.columns,
                    e = b.length,
                    c, k, g, h, n = this.firstRowAsNames,
                    m = -1 !== w(a, this.valueCount.xColumns),
                    r = [],
                    p = this.chartOptions,
                    q, u = (this.options.columnTypes || [])[a],
                ...
                m && b.mixed && (f[a] = d[a]);
                if (m && q && this.options.sort)
                    for (a = 0; a < f.length; a++) f[a].reverse(), n && f[a].unshift(f[a].pop())
            },
            dateFormats: {
                "YYYY-mm-dd": {
            ...
            parseDate: function(b) {
                var a = this.options.parseDate,
                    d, f, e = this.options.dateFormat || this.dateFormat,
                    c;
                if (a) d = a(b);
                else if ("string" === typeof b) {
                    if (e) a = this.dateFormats[e], (c = b.match(a.regex)) && (d = a.parser(c));
                    else
            ...
            rowsToColumns: function(b) {
                var a, d, f, e, c;
                if (b)
                    for (c = [], d = b.length, a = 0; a < d; a++)
                        for (e = b[a].length, f = 0; f < e; f++) c[f] || (c[f] = []), c[f][a] = b[a][f];
                return c
            },
            parsed: function() {
            ...
            getFreeIndexes: function(b, a) {
                ...
                for (b = 0; b < a.length; b += 1)
                    for (c = a[b].getReferencedColumnIndexes(), d = 0; d < c.length; d += 1) f[c[d]] = !1;
                ...
                if (d.complete || d.afterComplete) {
                    ...
                    if ("category" === a)
                        for (c = 0; c < g.length; c++)
                            for (h = g[c], e = 0; e < h.readers.length; e++) "x" === h.readers[e].configName && (h.readers[e].configName =
                                "name");
                    for (c = 0; c < g.length; c++) {
                        h = g[c];
                        e = [];
                    ...
                    a && (b.xAxis = {
                        type: a
                    }, "category" === a && (b.xAxis.uniqueNames = !1));
            ...
            a && a.data ? g.data(g.extend(a.data, {
                afterComplete: function(e) {
                    ...
                    if (a.hasOwnProperty("series"))
                        if ("object" ===
                            typeof a.series)
                            for (c = Math.max(a.series.length, e.series.length); c--;) k = a.series[c] || {}, a.series[c] = g.merge(k, e.series[c]);
        ...
        n.prototype.hasReader = function(b) {
            ...
            for (a = 0; a < this.readers.length; a += 1)
                if (d = this.readers[a], d.configName === b) return !0
        }
    })(p)
});