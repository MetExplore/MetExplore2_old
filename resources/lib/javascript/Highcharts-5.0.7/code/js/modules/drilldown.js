    ...
    (function(f) {
        ...
        q.prototype.addSingleSeriesAsDrilldown = function(a, b) {
            var d = a.series,
                ...
                u, m, A;
            A = {
                colorIndex: y(a.colorIndex, d.colorIndex)
            };
        ...
        q.prototype.drillUp = function() {
            for (var a = this, b = a.drilldownLevels, d = b[b.length - 1].levelNumber, c = b.length, e = a.series, h, g, k, f, m = function(b) {
                    var c;
                    l(e, function(a) {
                        a.options._ddSeriesId === b._ddSeriesId && (c = a)
                    });
                    c = c || a.addSeries(b, !1);
                    c.type === k.type && c.animateDrillupTo && (c.animate =
                        c.animateDrillupTo);
                    b === g.seriesOptions && (f = c)
                }; c--;)
                if (g = b[c], g.levelNumber === d) {
                    b.pop();
                    k = g.lowerSeries;
                    if (!k.chart)
                        for (h = e.length; h--;)
                            if (e[h].options.id === g.lowerSeriesOptions.id && e[h].options._levelNumber === d + 1) {
                                k = e[h];
                                break
                            }
                    k.xData = [];
        ...
        r.prototype.animateDrillupTo = function(a) {
            if (!a) {
                ...
                l(this.points, function(a) {
                    ...
                    b && (b.hidden = "hidden" ===
                        b.attr("visibility"), b.hidden || (b.hide(), a.connector && a.connector.hide()))
                });
                setTimeout(function() {
                    b.points && l(b.points, function(a, b) {
                        ...
                        if (e && !e.hidden && (e[b](c), a.connector)) a.connector[b](c)
                    })
        ...
        r.prototype.animateDrilldown = function(a) {
            var b = this,
                ...
                h = this.xAxis;
            a || (l(d, function(a) {
                b.options._ddSeriesId === a.lowerSeriesOptions._ddSeriesId && (c = a.shapeArgs)
            }), c.x += y(h.oldPos, h.pos) - h.pos, l(this.points, function(a) {
                a.graphic && a.graphic.attr(c).animate(p(a.shapeArgs, {
        ...
        r.prototype.animateDrillupFrom = function(a) {
            ...
            l(this.points,
                function(c) {
                    ...
                    e && (delete c.graphic, b ? e.animate(g, f.merge(b, {
                        complete: k
                    })) : (e.attr(g), k()))
                })
        };
        D && p(D.prototype, {
            ...
            animateDrilldown: function(a) {
                var b = this.chart.options.drilldown.animation,
                    d = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1].shapeArgs,
                    c = d.start,
                    e = (d.end - c) / this.points.length;
                a || (l(this.points,
                    function(a, g) {
                        var h = a.shapeArgs;
        ...
        x(f.Series.prototype, "drawDataLabels", function(a) {
            ...
            a.call(this);
            l(this.points, function(a) {
                a.drilldown && a.dataLabel &&
                    ("contrast" === b.color && d.getContrast(a.color || this.color), a.dataLabel.addClass("highcharts-drilldown-data-label"))
            }, this)
        });
        var B, w = function(a) {
            a.call(this);
