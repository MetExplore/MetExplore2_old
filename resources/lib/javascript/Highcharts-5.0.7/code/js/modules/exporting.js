...
(function(k) {
    ...
    (function(f) {
        ...
        y(A.prototype, {
            sanitizeSVG: function(a, b) {
                if (b && b.exporting && b.exporting.allowHTML) {
                    var c = a.match(/<\/svg>(.*?$)/);
                    c && (c = '\x3cforeignObject x\x3d"0" y\x3d"0" width\x3d"' + b.chart.width + '" height\x3d"' + b.chart.height + '"\x3e\x3cbody xmlns\x3d"http://www.w3.org/1999/xhtml"\x3e' + c[1] + "\x3c/body\x3e\x3c/foreignObject\x3e", a = a.replace("\x3c/svg\x3e", c + "\x3c/svg\x3e"))
                }
            ...
            getSVG: function(a) {
                var b, c, d, q, m, g = v(this.options, a);
                u.createElementNS || (u.createElementNS = function(a, b) {
                ...
                t(this.axes, function(a) {
                    var d = f.find(b.axes, function(b) {
                        ...
                        c = e.userMin,
                        e = e.userMax;
                    !d || void 0 === c && void 0 === e || d.setExtremes(c, e, !0, !1)
                });
                d = b.getChartHTML();
            ...
            print: function() {
                ...
                if (!a.isPrinting) {
                    ...
                    E(a, "beforePrint");
                    if (p = g && a.chartWidth > g) e = [a.options.chart.width, void 0, !1], a.setSize(g, void 0, !1);
                    t(m, function(a, b) {
            ...
            contextMenu: function(a, b, c, d, f, m, g) {
                ...
                n || (e[l] = n = w("div", {
                    ...
                    x(n, "mouseleave", function() {
                        n.hideTimer = setTimeout(k, 500)
                    }), x(n, "mouseenter", function() {
                        clearTimeout(n.hideTimer)
                    }), l = x(u, "mouseup", function(b) {
                        e.pointer.inClass(b.target, a) || k()
                    }), x(e, "destroy", l), t(b, function(a) {
                        if (a) {
                            var b;
                            b = a.separator ? w("hr", null, null, r) : w("div", {
                    ...
                    }), e.exportDivElements.push(r,
                        n), e.exportMenuWidth = n.offsetWidth, e.exportMenuHeight = n.offsetHeight);
                b = {
                    display: "block"
                };
                c + e.exportMenuWidth > p ? b.right = p - c - f - q + "px" : b.left = c - q + "px";
                d + m + e.exportMenuHeight > h && "top" !== g.alignOptions.verticalAlign ? b.bottom = h - d - q + "px" : b.top = d + m - q + "px";
                F(n, b);
                e.openMenu = !0
            },
            addButton: function(a) {
                ...
                if (!1 !== d.enabled) {
                    ...
                    f ? k = function(a) {
                        ...
                        b.contextMenu(e.menuClassName, m, e.translateX, e.translateY, e.width, e.height, e);
                        e.setState(2)
                    });
                    d.text && d.symbol ? h.paddingLeft = C(h.paddingLeft, 25) : d.text || y(h, {
                        width: d.width,
                        height: d.height,
                        padding: 0
                    });
                    e = c.button(d.text, 0, 0, k, h, n, l).addClass(a.className).attr({
                        title: b.options.lang[d._titleKey],
                        zIndex: 3
                    });
                    e.menuClassName = a.menuClassName || "highcharts-menu-" +
                        b.btnCount++;
                    d.symbol && (g = c.symbol(d.symbol, d.symbolX - p / 2, d.symbolY - p / 2, p, p).addClass("highcharts-button-symbol").attr({
                        zIndex: 1
                    }).add(e));
                    e.add().align(y(d, {
                        width: e.width,
            ...
            destroyExport: function(a) {
                ...
                a && (t(a, function(a, c) {
                        a && (a.onclick = a.ontouchstart = null, b.exportSVGElements[c] = a.destroy())
                    }),
                    a.length = 0);
                c && (t(c, function(a, c) {
        ...
        A.prototype.inlineStyles = function() {
            ...
            function b(c) {
                ...
                if (1 === c.nodeType && -1 === m.indexOf(c.nodeName)) {
                    l = z.getComputedStyle(c, null);
                    n = "svg" === c.nodeName ? {} : z.getComputedStyle(c.parentNode, null);
                    g[c.nodeName] || (e || (e = u.createElementNS(f.SVG_NS, "svg"), e.setAttribute("version", "1.1"), u.body.appendChild(e)), r = u.createElementNS(c.namespaceURI, c.nodeName), e.appendChild(r), g[c.nodeName] = v(z.getComputedStyle(r,
                        null)), e.removeChild(r));
                    for (h in l) {
                        r = !1;
                        for (q = k.length; q-- && !r;) r = k[q].test(h) || "function" === typeof l[h];
                        r || n[h] !== l[h] && g[c.nodeName][h] !== l[h] && (-1 !== d.indexOf(h) ? c.setAttribute(a(h), l[h]) : p += a(h) + ":" + l[h] + ";")
                    }
                    p && (h = c.getAttribute("style"), c.setAttribute("style", (h ? h + ";" : "") + p));
                    "text" !== c.nodeName && t(c.children || c.childNodes, b)
                }
            }
            var c = this.renderer,
        ...
        A.prototype.renderExporting = function() {
            ...
            if (d && !1 !== b.enabled) {
                for (a in c) this.addButton(c[a]);
                this.isDirtyExporting = !1
            }
            x(this, "destroy", this.destroyExport)
        };
        A.prototype.callbacks.push(function(a) {
            a.renderExporting();
            x(a, "redraw", a.renderExporting);
            t(["exporting", "navigation"], function(b) {
                a[b] = {
                    update: function(c, d) {
