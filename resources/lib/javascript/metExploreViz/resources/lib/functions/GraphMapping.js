 ...
 */
/**
 * @class metExploreD3.GraphMapping
 * Function to manage mapping data
 *
 * Import data
 * Map data on nodes and links
 * Map image on node
 *
 * @author MC
...
metExploreD3.GraphMapping = {
	...
	/***********************************************
	 * Mapping to data from file TSV
	 * This function will assign mapping value to each nodes in data
	 * @param {Mapping} mapping Empty mapping object
	 * @param {Object} objects Data conditions to assign
	...
	*/
	...
	/*****************************************************
	* Reload Mapping
	 * @param {Mapping} mapping Mapping object
	 * @throws error in function
	*/
	 ...
	 * @param {Object} aStyleFormParent Object used to know which style must be updated by mapping
	...
	*/
	...
	/***********************************************
	* Remove the mapping graphically
	* @param {String} panel Panel where mapping should be removed
	*/
	...
	/***********************************************
	 * Allow to wait mapping data loading
	 * @param {String} mappingId Id of mapping to launch
	 * @param {Function} func Callback function
	 */
	...
	/***********************************************
	 * Allow to wait mapping data loading
	 * @param {Mapping} mapping Mapping to load
	 * @param {Function} func Callback function
	 */
    ...
    * @param {Mapping} mappingObj Mapping to remove
	 * @fires removeMapping
    */
	...
	/***********************************************
	 * Load data mapping from JSON string
	 * @param {String} json Mapping json string
	 * @throws error in function
	 * @fires jsonmapping
	 */
	...
	/***********************************************
	 * Load data mapping from TSV file
	 * @param {String} url Mapping tsv file url
	 * @param {Function} func Callback function
	 * @fires jsonmapping
	 */
	...
	/***********************************************
	 * Load data mapping on nodes
	 * @param {Mapping} mapping Empty mapping object
	 * @param {Object} nodeMappingByCondition Data to map
	 */
     ...
     * @param {NodeData} node The node on which is mapped the image to select.
	 * @return {Element}
     */
     ...
     * @param {NodeData} node The node on which is mapped the image.
     */
     ...
     * @param {Element} image The g element containing the image on which to apply the event.
     */
     ...
     * @param {Element} image The g element containing the image on which to add the element
     */
     ...
     * @param {Element} image The g element containing the image to resize
     */
     ...
     * @param {NodeData} node The node whose label will be modified
     */
	...
	/***********************************************
	 * POC to compare  mapping condition with chart
	 * @deprecated
	 */
	 ...
	 * @param {} conditionName : Condition choosed by the user
	 * @fires afterSuggestionMapping setConditionProgramaticaly
	 * @deprecated
	 */
